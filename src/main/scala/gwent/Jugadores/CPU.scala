...
class CPU (_nombre: String, _seccionTablero: Tablero, _contadorGemas: Int, _mazoCartas: ListBuffer[Carta],
           _manoCartas: ListBuffer[Carta]) extends Jugador (_nombre, _seccionTablero, _contadorGemas: Int,
